        ...
        <div className="container mx-auto px-6 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-8">
            <div className="bg-white dark:bg-gray-900 shadow-lg rounded-lg p-6 max-w-xs animate-slide-up hover:scale-105 transition-transform duration-300">
              <div className="mb-4">
                <Image width={100} height={100} className="w-16 h-16 rounded-full mx-auto" src="https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=MnwzNjUyOXwwfDF8c2VhcmNofDF8fGNsaWVudHxlbnwwfHx8fDE2ODcxMjcyNzE&ixlib=rb-4.0.3&q=80&w=400" alt="Client 1" />
              </div>
            ...
            <div className="bg-white dark:bg-gray-900 shadow-lg rounded-lg p-6 max-w-xs animate-slide-up hover:scale-105 transition-transform duration-300 delay-100">
              <div className="mb-4">
                <Image   width={100} height={100} className="w-16 h-16 rounded-full mx-auto" src="https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=MnwzNjUyOXwwfDF8c2VhcmNofDF8fGNsaWVudHxlbnwwfHx8fDE2ODcxMjcyNzE&ixlib=rb-4.0.3&q=80&w=400" alt="Client 2" />
              </div>
            ...
            <div className="bg-white dark:bg-gray-900 shadow-lg rounded-lg p-6 max-w-xs animate-slide-up hover:scale-105 transition-transform duration-300 delay-200">
              <div className="mb-4">
                <Image width={200} height={200} className="w-16 h-16 rounded-full mx-auto" src="https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=MnwzNjUyOXwwfDF8c2VhcmNofDF8fGNsaWVudHxlbnwwfHx8fDE2ODcxMjcyNzE&ixlib=rb-4.0.3&q=80&w=400" alt="Client 3" />
              </div>
        ...
        <div className="container mx-auto px-6 text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="transform hover:scale-105 transition duration-300 ease-in-out bg-white dark:bg-gray-800 shadow-lg rounded-lg overflow-hidden">
              <Image width={100} height={100} className="w-full h-48 object-cover" src="/python.webp" alt="Blog 1" />
              <div className="p-6">
            ...
            <div className="transform hover:scale-105 transition duration-300 ease-in-out bg-white dark:bg-gray-800 shadow-lg rounded-lg overflow-hidden">
              <Image width={100} height={100} className="w-full h-48 object-cover" src="/python.webp" alt="Blog 2" />
              <div className="p-6">
                <h3 className="text-xl font-semibold text-gray-800 dark:text-gray-200 mb-2">
                  Python
                </h3>
            ...
            <div className="transform hover:scale-105 transition duration-300 ease-in-out bg-white dark:bg-gray-800 shadow-lg rounded-lg overflow-hidden">
              <Image width={100} height={100} className="w-full h-48 object-cover" src="/python.webp" alt="Blog 3" />
              <div className="p-6">
                <h3 className="text-xl font-semibold text-gray-800 dark:text-gray-200 mb-2">
                  TypeScript
                </h3>
